...
List<Book> popularBooks = popularBookData
    .map((item) => Book(item['title'] as String, item['author'] as String,
        item['image'] as String, item['description'] as String))
    .toList();

List<Book> newBooks = newBookData
    .map((item) => Book(item['title'] as String, item['author'] as String,
    item['image'] as String, item['description'] as String))
    .toList();
...
var newBookData = [
  ...
  },
  {
    ...
    "author": "Mike Brown",
    "price": "3",
    "image": "assets/images/img_newbook3.png",
    "description":
